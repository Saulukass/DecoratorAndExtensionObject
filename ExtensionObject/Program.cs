...
namespace ExtensionObject
    ...
    class Program
        ...
        static void Main(string[] args)
            ...
            (driver.GetExtension("BusDriver") as IBus).SetPassengersLimit(30);
            ...
            (driver.GetExtension("Delivery") as IDelivery).SetDeliveryDestination("Vilnius");
            driver.Drive();

            driver.RemoveExtension("BusDriver");
            Console.WriteLine("Lost job as bus driver. Salary " + driver.GetSalary() + " per month");
            
            Console.WriteLine("Considering risks working as bodyguard driver's salary " + (driver.GetExtension("Bodyguard") as IBodyguard).GetSalaryIncludingRisks() + " per month");
